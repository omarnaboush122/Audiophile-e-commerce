...
const Intro = () => {
  return (
    <section className="home-intro">
      <div className="container mx-auto flex flex-col justify-center items-center h-full text-white text-center px-6 border-t border-solid border-[rgb(255,255,255,0.2)] lg:text-left lg:items-start">
