...
const SpeakerZx9 = () => {
  return (
    <article className="bg-burntSienna text-white w-full py-14 px-6 flex flex-col gap-8 rounded-lg overflow-hidden md:gap-16 lg:flex-row lg:justify-center lg:gap-32">
    <img src={Speaker} alt="speaker-zx9" className="max-w-[10rem] mx-auto md:max-w-[12rem] lg:max-w-[410px] lg:m-0" />
